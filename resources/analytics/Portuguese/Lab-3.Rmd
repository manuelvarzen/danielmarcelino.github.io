...
```{r}
aggregate(SCORE ~ PUPILSEX, data = school, FUN = "mean")
```


```{r}
aggregate(SCORE ~ PUPILSEX, data = school, FUN = "median")
```


```{r}
aggregate(SCORE ~ PUPILSEX, data = school, FUN = "sd")
```
...
```{r}
aggregate(SCORE ~ PUPILSES + PUPILSEX,
           data = school, FUN = mean)
```


```{r}
aggregate(SCORE ~ PUPILSES + PUPILSEX,
           data = school, FUN = "median")
```

...
###Lecture 2: Importando dados e outras coisas básicas
author: Daniel Marcelino
date: Novembro 23, 2014
...
```{r}
papai_noel <- data.frame(crença=c('não acredita','não acredita','não acredita','não acredita',
 'acredita','acredita','acredita','acredita','acredita','acredita','não acredita','não acredita', 'acredita','acredita','não acredita','não acredita'), irmaos=c('irmão','irmão','irmão','irmã', 'sem','sem','sem','irmã', 'irmão','irmã','irmão','irmã', 'sem','irmã','irmão','sem'))
```
----
```{r}
 summary(papai_noel)
 
 totais = table(papai_noel$crença, papai_noel$irmaos)
...
```{r}
 mosaicplot(totais,main="Irmão Mais Velho Reduz Crença em Papai Noel",
              xlab="Acredita em Papai Noel",ylab="Tem irmãos mais velho?",
              col=c(2,3,4))
```			  
